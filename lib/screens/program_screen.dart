...
class ProgramScreen extends StatelessWidget{
    ...
    Widget build(BuildContext context){
        ...
        return Scaffold(
            appBar: AppBar(title: Text('Programa: ${name}')),
            body: FutureBuilder(
                ...
                builder: (context, snapshot){
                    ...
                    return SingleChildScrollView(child: Column(children: [
                        Image.network(
                            'https://special-olympics-api.herokuapp.com/programs/${id}/image',
                            fit: BoxFit.cover,
                            height: 300,
                                                        ...
                                                        return await showDialog(
                                                            ...
                                                            builder: (context){
                                                                return AlertDialog(
                                                                    ...
                                                                    content: Text('Para ver el manual de este programa deberá solicitar una cuenta.'),
                                                                    actions: [
                                                                        FlatButton(
                                                                            child: Text('Ok'),
                                                                            onPressed: (){
                                                        ...
                                                        return await showDialog(
                                                            ...
                                                            builder: (context){
                                                                return AlertDialog(
                                                                    ...
                                                                    content: Text('Para descargar el manual de este programa deberá solicitar una cuenta.'),
                                                                    actions: [
                                                                        FlatButton(
                                                                            child: Text('Ok'),
                                                                            onPressed: (){
